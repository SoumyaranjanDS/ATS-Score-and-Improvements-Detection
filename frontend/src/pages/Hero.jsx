...
const Hero = () => {
  return (
    <div className="min-h-screen bg-white text-white flex flex-col items-center justify-center gap-8 sm:gap-12 p-6 sm:p-12 md:p-16">
      ...
      />
      <button className="w-full sm:w-auto px-10 py-3.5 sm:py-4 bg-blue-600 text-white font-semibold text-lg sm:text-xl rounded-xl shadow-blue-500/25 hover:shadow-blue-500/40 hover:-translate-y-0.5 active:translate-y-0 text-center cursor-pointer border-0">
        Analyze
      </button>
    </div>
  );
